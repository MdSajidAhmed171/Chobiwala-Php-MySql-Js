...
<!-- Navbar Starts -->
  ...
  <div class="container">
    ...
    <?php 
      ...
      $query = "SELECT * FROM package ORDER BY id ASC"; /*!< read all packages.*/
      ...
      <div class="col-md-4">
        <div class="single_pack">
          ...
          <p class="pack-detail"><?php echo $row["description"]; ?></p>
          <h3>Cost : <?php echo $row["price"]; ?></h3>
          <h3><a href="checkout.php?id=<?php echo $row["id"]; ?>" class="get_btn">Order</a></h4>        
        </div>
      </div>
