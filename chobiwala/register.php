...
/** @defgroup register_view register_view
    User Registration.
@{ */
/*!***********************************************************************
 *************************************************************************
...
<html>
<head>
	<title>Welcome to Chobiwala!</title>
		...
		<div class="login_box">
			...
			<div id="second">
				...
				<form action="register.php" method="POST">
					...
					<?php if(in_array("<span style='color: #14C800;'>Registration Successful!</span><br>", $error_array)) echo "<span style='color: #14C800;'>You're all set! Go ahead and login!</span><br>"; ?>
